...
pointStyleB =   {'mew': 1, 'ms': 3, 'color': 'black'}
pointStyleG =   {'mew': 1, 'ms': 3, 'color': 'green'}
pointStyleO =   {'mew': 1, 'ms': 3, 'color': 'orange'}
pointStyleP =   {'mew': 1, 'ms': 3, 'color': 'purple'}
pointStyleR =   {'mew': 1, 'ms': 3, 'color': 'red'}
pointStyleY =   {'mew': 1, 'ms': 3, 'color': 'yellow'}
pointStyleHP =  {'mew': 1, 'ms': 3, 'color': 'hotpink'}
lineStyle =     {'linewidth': 0.5}
lineStyleBold = {'linewidth': 1}
histStyle =     {'facecolor': 'green', 'alpha': 0.5, 'edgecolor': 'black'}
font = fnt.FontProperties(family='C059', weight='normal', style='normal', size=8)

team_names_92 = ['Jagiellonian5_99816','FiscalFuries_21347','Lzxssx_522213','revitpo_711911','theMoneyMakers_420698','HIMS_1453','Globetrotters_20813']
...
plt.title("Profit or Loss", **titleFont)
plt.plot(Team0_Time, Team0, 'x', label = team_names_176[0], **pointStyleR)
plt.plot(Team1_Time, Team1, 'x', label = team_names_176[1], **pointStyleO)
plt.plot(Team2_Time, Team2, 'x', label = team_names_176[2], **pointStyleY)
plt.plot(Team3_Time, Team3, 'x', label = team_names_176[3], **pointStyleG)
plt.plot(Team4_Time, Team4, 'x', label = team_names_176[4], **pointStyle)
plt.plot(Team5_Time, Team5, 'x', label = team_names_176[5], **pointStyleP)
plt.plot(Team6_Time, Team6, 'x', label = team_names_176[6], **pointStyleB)
plt.plot(Team7_Time, Team7, 'x', label = team_names_176[7], **pointStyleHP)
