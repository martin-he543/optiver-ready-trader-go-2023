...
class AutoTrader(BaseAutoTrader):
    ...
    def price_estimate(self,best_future_ask_price,best_future_ask_volume,best_future_bid_price,best_future_bid_volume):
        ...
        price_prediction=best_future_ask_price+spread*weight
    ...
    def fair_prices(self,current_price,vol,BestFA,BestFB):
        ...
        return Call_ex_profit,Put_ex_profit
    ...
    def on_order_book_update_message(self, instrument: int, sequence_number: int, ask_prices: List[int],
        ...
        if instrument == Instrument.FUTURE:     
            ...
            if vol!=np.nan and vol!=0 and market_price!=np.nan:
                Call_exV,PutexV=self.fair_prices(market_price,vol,self.market_book[0,0,0,0],self.market_book[0,1,0,0])
                print('Call_exV: ', Call_exV)
                print('Put_exV: ', PutexV)
